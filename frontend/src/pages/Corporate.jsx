        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-white max-w-2xl">
              <p className="text-blue-200 font-semibold text-sm tracking-widest uppercase mb-3">Corporate Services</p>
              ...
              <div className="flex flex-wrap gap-3">
                <a href="#inquiry-form" className="theme-btn-primary px-7 py-3.5 rounded-lg font-semibold inline-flex items-center gap-2 theme-shadow-lg">
                  <EnvelopeIcon className="h-5 w-5" /> Get a Quote
                </a>
