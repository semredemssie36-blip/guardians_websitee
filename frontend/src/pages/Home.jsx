                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl lg:text-4xl font-bold theme-text-primary mb-6 mt-2">
                                Your Trusted Partner in <span className="highlight-word">Healthcare</span> Diagnostics
                            </h2>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-bold theme-text-primary mb-4 mt-2">
                            Comprehensive <span className="highlight-word">Diagnostic</span> Services
                        </h2>
            ...
            <section className="py-20 theme-bg-surface">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-bold theme-text-primary mb-4 mt-2">
                            Trusted. Reliable. <span className="highlight-word">Always Here</span> for You.
                        </h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <section className="py-20 theme-bg-background">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-bold theme-text-primary mb-4 mt-2">
                            Health Screening <span className="highlight-word">Packages</span> for Everyone
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {healthPackages.map((pkg, index) => (
                            <div key={index} className="theme-bg-card rounded-2xl theme-shadow-lg overflow-hidden hover:theme-shadow-xl transition-all duration-300 relative  border-b-4 border-guardians-cyan hover:border-guardians-navy">
                                {pkg.popular && (
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div>
                            ...
                            <h2 className="text-3xl lg:text-4xl font-bold theme-text-primary mb-6 mt-2">
                                Healthcare <span className="highlight-word">Solutions</span> for Organizations
                            </h2>
                            <p className="theme-text-secondary text-lg leading-relaxed mb-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="text-white">
                            ...
                            <h2 className="text-3xl lg:text-4xl font-bold mb-6 mt-2">
                                We Come <span className="highlight-word">to You</span>
                            </h2>
            ...
            <section className="py-20 theme-bg-background">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-bold theme-text-primary mb-4 mt-2">
                            Meet Our <span className="highlight-word">Expert</span> Doctors
                        </h2>
                        <p className="theme-text-secondary max-w-2xl mx-auto">
            ...
            <section className="py-20 theme-bg-surface">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-bold theme-text-primary mb-4 mt-2">
                            Latest <span className="highlight-word">Health</span> Articles
                        </h2>
                        <p className="theme-text-secondary max-w-2xl mx-auto">
                    ...
                    <div className="theme-bg-primary rounded-3xl p-12 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
                                Ready to Take Care of <span className="highlight-word">Your Health</span>?
                            </h2>
            ...
            <section className="py-20 theme-bg-surface">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-bold theme-text-primary mb-4 mt-2">
                            Location &amp; <span className="highlight-word">Contact</span>
                        </h2>
                        <p className="theme-text-secondary max-w-2xl mx-auto">
